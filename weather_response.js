	...
	if (res.indexOf("home") > -1){
		...
		for (var key in inputdata.states) {
			if (citystate.indexOf(key) > -1) {
				...
				if(inputdata.states[state]=="ES"){
					var url = config.WEATHERURL + "/api/weather/v3/location/search?query="+ escape(city.trimRight()) + "&locationType=city&language=en-US&countryCode=ES";
